...
This file licensed to R_GENESIS (http://themeforest.net/user/r_genesis) and itÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂs strictly prohibited to copy or reuse it.
	...
	rgen.vide = function (obj) {
		...
		$(obj).vide({
			...
			poster: videofile + ".jpg"
				...
				posterType: 'jpg', // Poster image type. "detect" ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ auto-detection; "none" ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ no poster; "jpg", "png", "gif",... - extensions.
